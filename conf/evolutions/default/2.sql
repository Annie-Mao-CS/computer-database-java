...
insert into genus (id,scientific_name) values (  1,'Apteryx');
insert into species (id,local_name,scientific_name,documented,can_fly,is_extinct,genus_id) values (  1,'Southern brown kiwi','Apteryx australis','1811-01-01',false,false,1);
